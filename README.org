...
* Docker Compose File for OHIF with ORTHANC, and dicom-router satusehat
...
*** Clone This Repo
#+begin_src bash
git clone https://github.com/t4m1n/orthanc-ohif-dcmr.git
cd orthanc-ohif-dcmr
...
sumber asli:
https://github.com/hyper4saken/ohif-orthanc.git
